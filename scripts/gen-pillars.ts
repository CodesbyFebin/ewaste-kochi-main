...
const PILLARS: (Pillar & { hub: HubKey })[] = [
  ...
  // ---------------- LOCATIONS & SERVICES ----------------
  {
    ...
    sections: [
      { h: "Metro areas served", p: ["Core Kochi localities are commonly serviceable with the right item details.","Kakkanad, Kalamassery, Edappally, Vyttila and Thrippunithura are frequent pickup zones."] },
      { h: "How coverage is confirmed", p: ["Feasibility depends on item type, quantity, condition and access.","The team reviews your list and photos rather than assuming coverage."] },
      { h: "Apartments and offices", p: ["Apartments share building and lift details; offices share inventories and access.","Both models work when prepared in advance."] },
      { h: "If your area is borderline", p: ["Some requests need drop-off or special handling instead of doorstep.","The team suggests the realistic option instead of a false yes."] },
    ],
    faqs: [
      { q: "Is my area covered?", a: "Send locality, items and photos; the team confirms feasibility." },
      { q: "Which metro areas are common?", a: "Ernakulam, Kakkanad, Kalamassery, Edappally, Vyttila, Thrippunithura." },
      { q: "What if doorstep isn't feasible?", a: "The team proposes drop-off or alternative handling." },
  ...
  },
  {
    ...
    sections: [
      { h: "Ernakulam coverage", p: ["Both central and South Ernakulam see regular pickups when details are clear.","Share your exact locality so the route can be matched."] },
      { h: "Preparing your request", p: ["List items, quantities, condition and photos as you would for any Kochi pickup.","Mention batteries or data devices so routing is correct."] },
      { h: "South Ernakulam note", p: ["South Ernakulam is a well-covered pocket with established collection patterns.","Confirming via photos keeps slots realistic."] },
      { h: "What to expect", p: ["A confirmation-first flow: review, clarify, then schedule.","Functional items may be reviewed for resale; broken ones go to recycling."] },
    ],
    faqs: [
      { q: "Do you cover South Ernakulam?", a: "Yes, it is commonly serviceable; confirm with your locality details." },
      { q: "What should I send first?", a: "Locality, item list, quantities, condition and photos." },
      { q: "Is pickup free?", a: "Household pickup is typically free; premium steps may differ." },
      { q: "How is the slot confirmed?", a: "After the team reviews your list and photos for feasibility." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Why Kakkanad is well covered", p: ["High volumes of IT assets make Kakkanad and Infopark frequent pickup zones.","Offices and apartments alike can arrange collections with clear details."] },
      { h: "Office and campus requests", p: ["IT parks share asset inventories, access windows and data-destruction needs.","Bulk lots are easier to plan when listed in advance."] },
      { h: "Residences and societies", p: ["Nearby apartments can batch collections for convenience.","Building and lift details help the team plan the slot."] },
      { h: "Confirming the slot", p: ["As everywhere, feasibility is confirmed after reviewing your items and photos.","Data-bearing devices are routed through certified destruction."] },
    ],
    faqs: [
      { q: "Do you cover Infopark offices?", a: "Yes, IT-park pickups are common with an inventory shared in advance." },
      { q: "What helps a fast slot?", a: "Clear item list, quantities, access window and photos." },
      { q: "Is data destruction available?", a: "Yes, for storage-bearing devices, with certificates." },
      { q: "Can societies batch pickups?", a: "Yes, apartment batches are straightforward to arrange." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Kalamassery coverage", p: ["The Hitech Park area and surrounding localities see regular pickups.","Share your exact pocket so the route matches."] },
      { h: "Industrial and office mix", p: ["Nearby industrial units and offices can arrange bulk collections.","Inventories and access windows make bulk lots smoother."] },
      { h: "Residential requests", p: ["Homes and apartments follow the same confirmation-first flow.","Battery separation and photos speed up the review."] },
      { h: "What to expect", p: ["Review, clarify, then schedule — no assumed coverage.","Functional items may be reviewed for resale."] },
    ],
    faqs: [
      { q: "Do you cover Hitech Park?", a: "Yes, that belt is commonly serviceable; confirm with details." },
      { q: "Can offices do bulk pickup?", a: "Yes, with an inventory and access window shared early." },
      { q: "What should residents send?", a: "Locality, item list, condition and photos." },
      { q: "How is the slot confirmed?", a: "After feasibility review of your list and photos." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Edappally coverage", p: ["The junction and metro corridor are well within common service areas.","Exact pocket details help match the route."] },
      { h: "Homes and apartments", p: ["Residences follow the standard confirmation-first flow with photos.","Societies can batch collections for ease."] },
      { h: "Shops and small offices", p: ["Retail and small offices can arrange pickups with an item list.","Mention batteries and data devices up front."] },
      { h: "Confirmation flow", p: ["Feasibility is reviewed before any slot is promised.","This avoids unreliable doorstep commitments."] },
    ],
    faqs: [
      { q: "Is Edappally covered?", a: "Yes, generally; confirm with your exact locality and items." },
      { q: "Can shops book pickup?", a: "Yes, with a clear item list and photos." },
      { q: "Do societies batch?", a: "Yes, apartment batches are easy to arrange." },
      { q: "How is the slot set?", a: "After review of your list and photos for feasibility." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Vyttila coverage", p: ["The transit hub and nearby residential zones are commonly serviceable.","Pinpoint your pocket for an accurate route match."] },
      { h: "Apartments and homes", p: ["Residences use the standard flow with photos and battery separation.","Societies can combine collections."] },
      { h: "Commercial zones", p: ["Small offices and shops can book with an item list.","Bulk lots need inventory and access details."] },
      { h: "Feasibility first", p: ["The team reviews before promising a slot, keeping expectations honest.","Functional items may be reviewed for resale."] },
    ],
    faqs: [
      { q: "Is Vyttila covered?", a: "Yes, generally; confirm with your locality and items." },
      { q: "Can apartments batch?", a: "Yes, society batches are straightforward." },
      { q: "Do shops qualify?", a: "Yes, with a clear item list and photos." },
      { q: "How is the slot confirmed?", a: "After feasibility review of your list and photos." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Thrippunithura coverage", p: ["The town and nearby localities are commonly serviceable with clear details.","Share your area so the route is matched accurately."] },
      { h: "Residential requests", p: ["Homes follow the standard confirmation-first flow with photos.","Battery separation helps the review."] },
      { h: "Small offices", p: ["Local offices can book with an item list and access details.","Bulk lots need inventory shared early."] },
      { h: "Confirmation flow", p: ["Feasibility is reviewed before any slot is promised.","This keeps the commitment reliable."] },
    ],
    faqs: [
      { q: "Is Thrippunithura covered?", a: "Yes, generally; confirm with your locality and items." },
      { q: "What should I send?", a: "Area, item list, condition and photos." },
      { q: "Can offices book?", a: "Yes, with inventory and access details." },
      { q: "How is the slot set?", a: "After review of your list and photos for feasibility." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Aluva coverage", p: ["North Kochi localities including Aluva are commonly serviceable.","Exact pocket and items determine the route."] },
      { h: "Industrial requests", p: ["The industrial belt can arrange bulk pickups with inventories.","Access and loading details help planning."] },
      { h: "Residential requests", p: ["Homes use the standard flow with photos and battery separation.","Societies can batch collections."] },
      { h: "Feasibility first", p: ["The team reviews before promising a slot, keeping it honest.","Functional items may be reviewed for resale."] },
    ],
    faqs: [
      { q: "Is Aluva covered?", a: "Yes, generally; confirm with your locality and items." },
      { q: "Can industry do bulk?", a: "Yes, with inventory and access details." },
      { q: "Do homes qualify?", a: "Yes, with a clear list and photos." },
      { q: "How is the slot confirmed?", a: "After feasibility review of your list and photos." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Fort Kochi coverage", p: ["The heritage area and nearby localities are commonly serviceable.","Share your exact spot so the route matches."] },
      { h: "Guesthouses and small biz", p: ["Small hospitality and retail can book with an item list.","Bulk lots need inventory and access details."] },
      { h: "Residential requests", p: ["Homes use the standard flow with photos and battery separation.","Societies can combine collections."] },
      { h: "Confirmation flow", p: ["Feasibility is reviewed before any slot is promised.","This keeps commitments reliable."] },
    ],
    faqs: [
      { q: "Is Fort Kochi covered?", a: "Yes, generally; confirm with your locality and items." },
      { q: "Can guesthouses book?", a: "Yes, with a clear item list and photos." },
      { q: "Do homes qualify?", a: "Yes, with the standard flow." },
      { q: "How is the slot set?", a: "After review of your list and photos for feasibility." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Step 1: send the request", p: ["Message your area, item names, quantities, condition and photos.","This single message lets the team start the review."] },
      { h: "Step 2: confirm feasibility", p: ["The team checks item type, quantity, access and location.","They clarify the route — recycling, resale, data destruction or ITAD."] },
      { h: "Step 3: prepare", p: ["Keep items dry, separate batteries, and have photos ready.","Group by type so loading is quick and safe."] },
      { h: "Step 4: hand over", p: ["At the slot, items are collected and acknowledgement given.","Certificates are issued where required for compliance."] },
    ],
    faqs: [
      { q: "Is doorstep pickup free?", a: "For most household items, yes; premium steps may differ." },
      { q: "What do I send first?", a: "Area, items, quantities, condition and photos." },
      { q: "How is feasibility confirmed?", a: "The team reviews your details and matches the route." },
  ...
  // ---------------- LOCATIONS (extended) ----------------
  {
    ...
    sections: [
      { h: "Palarivattom coverage", p: ["The junction and nearby localities are commonly serviceable.","Share your exact spot for an accurate route."] },
      { h: "Shops and offices", p: ["Small businesses book with an item list and access details.","Bulk lots need inventory shared early."] },
      { h: "Residences", p: ["Homes use the standard flow with photos and battery separation.","Societies can batch collections."] },
      { h: "Feasibility first", p: ["The team reviews before promising a slot.","Keeps the commitment reliable."] },
    ],
    faqs: [
      { q: "Is Palarivattom covered?", a: "Yes, generally; confirm with details." },
      { q: "Shops book?", a: "Yes, with item list and access." },
      { q: "Societies batch?", a: "Yes, straightforward to arrange." },
      { q: "Slot confirmed how?", a: "After feasibility review of list and photos." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Kadavanthra coverage", p: ["The area and nearby pockets are commonly serviceable.","Exact locality helps match the route."] },
      { h: "Apartments", p: ["Residences follow the standard flow with photos.","Societies can combine collections."] },
      { h: "Commercial zones", p: ["Shops and offices book with an item list.","Bulk lots need inventory and access."] },
      { h: "Confirmation flow", p: ["Feasibility reviewed before any slot is promised.","Functional items may be reviewed for resale."] },
    ],
    faqs: [
      { q: "Is Kadavanthra covered?", a: "Yes, generally; confirm with details." },
      { q: "Apartments batch?", a: "Yes, societies can combine." },
      { q: "Commercial book?", a: "Yes, with item list." },
      { q: "Slot how?", a: "After feasibility review." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Maradu coverage", p: ["Residential belts south of Kochi are commonly serviceable.","Share your pocket for route matching."] },
      { h: "Residences", p: ["Homes use the standard flow with photos and battery separation.","Societies can batch collections."] },
      { h: "Small offices", p: ["Local offices book with an item list and access.","Bulk lots need inventory."] },
      { h: "Feasibility first", p: ["The team reviews before promising a slot.","Keeps commitment reliable."] },
    ],
    faqs: [
      { q: "Is Maradu covered?", a: "Yes, generally; confirm with details." },
      { q: "Societies batch?", a: "Yes, easy to arrange." },
      { q: "Offices book?", a: "Yes, with item list." },
      { q: "Slot confirmed how?", a: "After feasibility review." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Kundannoor coverage", p: ["The junction and southern corridor are commonly serviceable.","Share exact locality for route match."] },
      { h: "Homes and shops", p: ["Residences and small businesses follow the standard flow.","Photos and battery separation help."] },
      { h: "Bulk requests", p: ["Offices book with inventory and access details.","Bulk lots planned in advance."] },
      { h: "Confirmation flow", p: ["Feasibility reviewed before any slot promised.","Functional items may be reviewed for resale."] },
    ],
    faqs: [
      { q: "Is Kundannoor covered?", a: "Yes, generally; confirm with details." },
      { q: "Shops book?", a: "Yes, with item list." },
      { q: "Bulk planned?", a: "Yes, with inventory and access." },
      { q: "Slot how?", a: "After feasibility review." },
    ],
  ...
  },
  {
    ...
    sections: [
      { h: "Campus coverage", p: ["Infopark is a well-covered IT corridor.","Campus and building details help planning."] },
      { h: "Bulk IT assets", p: ["Companies share inventories and access windows.","Data destruction is arranged for storage devices."] },
      { h: "Nearby facilities", p: ["Adjacent offices and flats can join batches.","Grouping reduces trips and effort."] },
      { h: "Confirmation flow", p: ["Feasibility reviewed before scheduling a slot.","Certificates document the batch."] },
    ],
    faqs: [
      { q: "Infopark covered?", a: "Yes, a well-covered corridor." },
      { q: "Bulk IT?", a: "Yes, with inventory and access." },
      { q: "Nearby join?", a: "Yes, via batched collections." },
      { q: "Slot confirmed how?", a: "After feasibility review." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Confirm how?", a: "After photos and model details." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Confirmation", p: ["The team reviews before scheduling.","Functional items may be reviewed for resale."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Confirmation", p: ["The team reviews before scheduling.","Bulk lots need quantity details."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Confirmation", p: ["The team reviews before scheduling.","Small volumes may join a batch pickup."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Confirmation", p: ["The team reviews before scheduling.","Bulk board lots need details."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Confirmation", p: ["The team reviews before scheduling.","Group accessories for efficiency."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Confirmation", p: ["The team reviews before scheduling.","Bulk office lots need an inventory."] },
    ],
    faqs: [
