...
export const SEO_OVERRIDES: Record<string, SeoOverride> = {
  ...
  "/recycling/": {
    ...
    description: "Find out where to recycle old electronics in Kochi. See accepted items, doorstep pickup, battery handling, data safety and how to check collection feasibility.",
    intentional: true,
    source: "GSC P99 CTR pass 2026-08-10",
    reason: "CTR-focused pillar snippet for the primary recycling intent.",
  },
  "/marketplace/": {
  ...
  "/battery-recycling/": {
    title: "Where to Recycle Batteries in Kochi | UPS, Inverter & Lithium",
    description: "Learn where to recycle UPS, inverter, laptop and lithium batteries in Kochi. Get safe handling guidance and check pickup feasibility for your batteries.",
    intentional: true,
    source: "GSC P99 CTR pass 2026-08-10",
    reason: "Battery query coverage with safe category wording.",
  },
  "/sell-electronics/": {
  ...
  "/blog/ewaste-donation-reuse-guide-kochi/": {
    title: "Donate Old Electronics in Kochi + Free Pan-India Ship-In",
    description: "Donate working laptops, phones and tablets. Kochi doorstep pickup — free. Pan-India ship-in — free, we cover Shiprocket for eligible categories. WhatsApp us.",
    intentional: true,
    source: "GSC zero-CTR rewrite 2026-08-14; Shiprocket operation confirmed 2026-08-05",
    reason: "High-impression zero-click page; expose verified category-bounded ship-in differentiator.",
  },
  "/locations/kakkanad/": {
