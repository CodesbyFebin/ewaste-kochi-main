...
export const INDUSTRY_GUIDES_2: DiscoveryGuide[] = [
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for Hospitality Businesses in Kochi",
    metaDescription: "Plan hotel and resort electronics disposal with room-by-room inventory, data controls and confirmed collection for TVs, minibars and guest devices.",
    primaryKeyword: "hospitality e-waste kochi",
    secondaryKeyword: "hotel electronics recycling kochi",
    internalLinks: ["recycling", "electronics-recycling", "pickup", "data-destruction"],
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "E-Waste Recycling for Marine & Fishing Businesses in Kochi",
    metaDescription: "Plan disposal of marine electronics, navigation equipment, safety devices and fishing fleet electronics with salt-exposure handling and data controls.",
    primaryKeyword: "marine electronics recycling kochi",
    secondaryKeyword: "boat e-waste disposal kochi",
    internalLinks: ["battery-recycling", "recycling", "electronics-recycling", "sell-electronics", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for Agriculture Businesses in Kerala",
    metaDescription: "Plan disposal of farm electronics, sensor systems, irrigation controllers and dairy equipment with moisture handling and data controls. Plan safe disposal with",
    primaryKeyword: "agricultural e-waste kerala",
    secondaryKeyword: "farm equipment recycling kerala",
    internalLinks: ["battery-recycling", "recycling", "electronics-recycling", "pickup", "sell-electronics"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for Telecom Businesses in Kochi",
    metaDescription: "Plan disposal of telecom towers, customer premises equipment, routers and mobile infrastructure with data controls and antenna handling. Plan safe disposal wit",
    primaryKeyword: "telecom e-waste kochi",
    secondaryKeyword: "cell tower electronics recycling kochi",
    internalLinks: ["itad", "recycling", "data-destruction", "electronics-recycling", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "E-Waste Recycling for Data Centers in Kochi",
    metaDescription: "Plan data center equipment retirement with server rack handling, witnessed data destruction, CPCB-compliant routing and material recovery reporting.",
    primaryKeyword: "data center e-waste kochi",
    secondaryKeyword: "server disposal kochi",
    internalLinks: ["itad", "data-destruction", "electronics-recycling", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for Retail Chains in Kerala",
    metaDescription: "Plan multi-store electronics disposal for retail chains with POS systems, digital signage, self-checkout and back-office equipment. Plan safe disposal with CPC",
    primaryKeyword: "retail e-waste kerala",
    secondaryKeyword: "store electronics recycling kerala",
    internalLinks: ["recycling", "sell-electronics", "electronics-recycling", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for Construction Businesses in Kochi",
    metaDescription: "Plan disposal of construction site electronics, surveying equipment, cameras and office IT with site-access and data controls. Plan safe disposal with CPCB-com",
    primaryKeyword: "construction e-waste kochi",
    secondaryKeyword: "construction equipment recycling kochi",
    internalLinks: ["recycling", "electronics-recycling", "sell-electronics", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for Logistics in Kochi",
    metaDescription: "Plan disposal of fleet electronics, warehouse scanners, tracking devices and office IT with fleet data controls and battery handling. Plan safe disposal with C",
    primaryKeyword: "logistics e-waste kochi",
    secondaryKeyword: "fleet electronics disposal kochi",
    internalLinks: ["recycling", "electronics-recycling", "sell-electronics", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "Best E-Waste Recycling for EdTech in Kochi",
    metaDescription: "Plan disposal of learning devices, interactive displays, lab equipment and student data systems with privacy and device lifecycle controls. Plan safe disposal ",
    primaryKeyword: "edtech e-waste kochi",
    secondaryKeyword: "school electronics recycling kochi",
    internalLinks: ["recycling", "electronics-recycling", "data-destruction", "sell-electronics"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
  ...
  },
  {
    ...
    module: "industries-2",
    bucket: "commercial",
    metaTitle: "E-Waste Recycling for Healthcare Technology in Kochi",
    metaDescription: "Plan disposal of medical devices, patient monitoring systems, diagnostic equipment and healthcare IT with privacy, safety and compliance controls.",
    primaryKeyword: "healthcare e-waste kochi",
    secondaryKeyword: "medical equipment recycling kochi",
    internalLinks: ["recycling", "data-destruction", "electronics-recycling", "pickup"],
    cta: { headline: "Ready for compliant e-waste collection?", text: "Schedule a pickup with our CPCB-authorized team in Kochi.", url: "/pickup/", label: "Schedule pickup" },
    lastUpdated: "2026-09-18",
