...
export const HOW_TO_GUIDES: DiscoveryGuide[] = [
  {
    ...
    steps: [
      { name: "Inventory and decide", text: "List the laptop, charger and accessories; note faults and obtain disposal approval where needed. Ask whether reuse assessment is appropriate." },
      { name: "Protect information", text: "Check your backup, sign out of accounts and arrange a storage-appropriate sanitization method. Do not treat a failed reset as successful erasure." },
      { name: "Confirm and hand over", text: "Verify the recipient, accepted condition, fees and documentation. Match the laptop identifier to the handover receipt and track unresolved data treatment." },
    ],
