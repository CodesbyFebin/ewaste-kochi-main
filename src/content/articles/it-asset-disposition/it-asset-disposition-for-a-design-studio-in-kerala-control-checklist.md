---
title: "IT Asset Disposition for a Design Studio in Kerala: Control Checklist"
description: "A practical, evidence-aware guide to a defensible ITAD workflow suited to a design studio, with safety, data and compliance checkpoints for Kerala."
slug: "itad/it-asset-disposition-for-a-design-studio-in-kerala-control-checklist"
...
related:
  ...
  - /itad/it-asset-disposition-for-a-school-in-kerala-control-checklist/
...
For a design studio, procurement, IT, information security and finance may each own part of the evidence. A named coordinator should reconcile the release list, collection receipt, sanitisation result, resale statement and final treatment report.

## Use a closing checklist

Before it asset fleet leaves control, confirm that ownership release is approved, accounts and access are handled, hazardous condition is disclosed, accessories are sorted and the receiver accepts the category. Confirm who holds responsibility for sanitisation and what evidence will be returned.
...
Start with observable facts about the it asset fleet: model family, approximate age, working condition, accessories, battery state and visible damage. For organisational equipment, add the asset tag, serial number, assigned owner and storage-media type. This profile determines whether testing, repair, data work or hazardous handling is needed.
