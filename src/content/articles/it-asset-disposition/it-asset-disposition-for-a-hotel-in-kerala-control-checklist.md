---
title: "IT Asset Disposition for a Hotel in Kerala: Control Checklist"
description: "A practical, evidence-aware guide to a defensible ITAD workflow suited to a hotel, with safety, data and compliance checkpoints for Kerala."
slug: "itad/it-asset-disposition-for-a-hotel-in-kerala-control-checklist"
...
For a hotel, procurement, IT, information security and finance may each own part of the evidence. A named coordinator should reconcile the release list, collection receipt, sanitisation result, resale statement and final treatment report.
