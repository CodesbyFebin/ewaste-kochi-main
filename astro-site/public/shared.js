...
const FOOTER_AREAS = [
  ...
  { label: 'Thiruvananthapuram', href: '/locations/thiruvananthapuram/' },
  { label: 'All 32 Locations →', href: '/locations/' },
];

const FOOTER_HUB_PILLARS = [
  { label: 'IT Asset Disposal (ITAD)', href: '/blog/itad/' },
  { label: 'Data Destruction', href: '/blog/data-destruction/' },
  { label: 'E-Waste Recycling', href: '/blog/recycling/' },
  { label: 'E-Waste Collection', href: '/blog/collection/' },
];
  ...
  <footer>
    <div class="container">
      <div class="footer-grid">
        <!-- Brand -->
        <div>
          <div class="footer-brand-logo" style="margin-bottom:1.5rem">
            <img src="/logo.svg" alt="Ewaste Kochi Logo" width="220" height="60" style="filter: brightness(0) invert(1); max-width:180px; height:auto;">
          </div>
        ...
        <div>
          ...
          <div class="footer-links">
            ...
            <a href="/locations/" style="font-weight:700">Service Locations</a>
        ...
        <!-- Local Hubs & Areas -->
        <div>
          <div class="footer-col-title">Local Service Hubs</div>
          <div class="footer-links" style="margin-bottom: 1.5rem;">
            ${FOOTER_HUB_PILLARS.map(p => `<a href="${p.href}">${p.label}</a>`).join('')}
          </div>
          <div class="footer-col-title">Top Service Areas</div>
          <div class="footer-links">
            ${FOOTER_AREAS.slice(0, 5).map(a => `<a href="${a.href}">${a.label}</a>`).join('')}
            <a href="/locations/" style="font-weight:700">All 32 Locations →</a>
          </div>
        </div>
        <!-- Contact -->
        <div>
